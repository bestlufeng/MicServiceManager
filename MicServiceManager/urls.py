...
urlpatterns = [
    ...
    url(r'^v1/micservice_config_params/(?P<micServiceId>\d)/(?P<envId>\d+)$',views.micservice_config_params),  # 微服务环境配置 键值对
    # url(r'^v1/service',views.service),

    #jenkins 相关接口
    url(r'^v1/jenkins_file/(?P<micServiceId>\d)/(?P<envId>\d+)$',views.jenkins_file),  # 微服务环境配置 键值对
    #k8s相关接口
